...
class TestFunction(unittest.TestCase):
  ...
  ltMain = var1 + var2
  varFunctions = LinearTerm.map_int_FunctionPtr({var1.ID(): Function.Function_xn(1), var2.ID(): Function.Function_yn(1), var3.ID(): Function.Function_xn(2), var4.ID(): Function.Function_yn(3)})
